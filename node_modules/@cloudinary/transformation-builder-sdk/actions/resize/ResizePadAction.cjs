...
var ResizePadAction = /** @class */ (function (_super) {
    ...
    ResizePadAction.prototype.background = function (backgroundQualifier) {
        ...
        if (qualifiers_background_shared_BackgroundGenerativeFillQualifier.isGenerativeFillBackgroundValue(backgroundQualifier)) {
            parsedBackgroundQualifier = new qualifiers_background_shared_BackgroundGenerativeFillQualifier.BackgroundGenerativeFillQualifier(backgroundQualifier);
        }
        this._actionModel.background = internal_models_createBackgroundModel.createBackgroundModel(parsedBackgroundQualifier);
